				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<!-- Mensagem de cadrasto inicio -->
							 <?php
							 	if (isset($_SESSION['mensagem'])):
							 ?>
							 <div class="alert alert-info alert-dismissible fade show" roler="alert">
								<?= $_SESSION['mensagem'];?>
								<button type="button" class="bnt-close" data_bs_dismiss="alert" arial-label="Close"></button>
							 </div>
							 <?php
							 	unset($_SESSION['mensagem']); //limpa a mnesagem antes de algo
								endif;
							 ?>
							<!-- Mensagem de cadrasto final -->
